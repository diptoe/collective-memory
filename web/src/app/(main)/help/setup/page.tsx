      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="p-3 bg-cm-terracotta/10 rounded-xl">
            <Settings className="w-8 h-8 text-cm-terracotta" />
          </div>
          <div>
            <h1 className="text-2xl font-semibold text-cm-charcoal">Client Setup</h1>
            <p className="text-cm-coffee">Configure your AI client to connect to Collective Memory</p>
          </div>
        </div>
          ...
          <div className="bg-cm-sand/30 rounded-lg p-4">
            ...
            <ul className="text-sm text-cm-coffee space-y-1">
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cm-success flex-shrink-0" />
                No local dependencies (Python, uv, etc.)
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cm-success flex-shrink-0" />
              ...
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cm-success flex-shrink-0" />
                Automatic updates — always uses latest MCP server
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cm-success flex-shrink-0" />
        ...
        <section className="bg-cm-sand/30 border border-cm-sand rounded-xl p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link
              href="/settings"
              className="p-4 bg-cm-ivory border border-cm-sand rounded-lg hover:border-cm-terracotta transition-colors"
            >
              <div className="flex items-center gap-2 mb-1">
                <span>🔑</span>
                <h3 className="font-medium text-cm-charcoal">Access Tokens</h3>
              </div>
              <p className="text-xs text-cm-coffee">Manage your Personal Access Tokens</p>
            </Link>
            <Link
              href="/help/sse"
              className="p-4 bg-cm-ivory border border-cm-sand rounded-lg hover:border-cm-terracotta transition-colors"
            >
              <div className="flex items-center gap-2 mb-1">
                <span>🌐</span>
                <h3 className="font-medium text-cm-charcoal">SSE Details</h3>
              </div>
              <p className="text-xs text-cm-coffee">Transport details & self-hosting</p>
            </Link>
          </div>
        </section>
      </div>
